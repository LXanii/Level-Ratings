...
class $modify(ratioDisplay, LevelInfoLayer) {
	...
	bool init(GJGameLevel* p0, bool p1) {
		...
		if (ratingRatio >= 8) {
			...
			else if (m_level->m_stars.value() != 0) magicString = "It's possible this level was a victim of likebotting, or that the publisher of this level was caught in a recent controversy. In either case, that's not for me to say; I'm not a psychic.";
